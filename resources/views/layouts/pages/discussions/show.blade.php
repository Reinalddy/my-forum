                  ...
                  <div class="row align-items-start justify-content-between">
                    <div class="col">
                      <span class="color-gray me-2">
                        ...
                        <input type="text" value="{{ url('discussions/lorem') }}" id="curent-url" class="d-none">
                      </span>
                    </div>
          ...
          <div class="col-12 col-lg-4">
            <div class="card">
              ...
              <div>
                ...
                <a href=""><span class="badge rounded-pill text-bg-light">Facades</span></a>
    ...
    <script>
      $(document).ready(function() {
        $('#share-discussions').click(function() {
          ...
          var alerContainer = alert.find('.container');
          alerContainer.first().text('Link to this discussion copied susscessfully')
        });
      });
    </script>
@endsection