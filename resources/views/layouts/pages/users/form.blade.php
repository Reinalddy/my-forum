            ...
            <form action="">
              <div class="d-flex flex-column flex-md-row mb-4">
                <div class="edit-avatar-wrapper mb-3 mb-md-0 mx-auto mx-md-0">
                  <div class="avatar-wrapper rounded-circle overflow-hidden flex-lg-shrink-0 me-4">
                    <img id="avatar" src="{{ url('assets/images/avatar.png') }}" alt="" class="avatar">

                  </div>
                  <label for="picture" class="btn p-0 edit-avatar-show">
                    <img src="{{ url('assets/images/edit-circle.png') }}" alt="">
                  </label>
                  <input type="file" name="picture" id="picture" accept="image/*" class="d-none is-invalid">
                </div>
                <div>
                  <div class="mb-3">
